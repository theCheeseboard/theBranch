...
FORWARD_DECLARE(LGConfig)
FORWARD_DECLARE(LGTag)
FORWARD_DECLARE(LGAnnotatedTag)
FORWARD_DECLARE(LGLightweightTag)

FORWARD_DECLARE(ICommitResolvable)
...
FORWARD_DECLARE(Revert)
FORWARD_DECLARE(RetroactiveRebase)
FORWARD_DECLARE(RetroactiveGitOperation)
FORWARD_DECLARE(Tree)
FORWARD_DECLARE(Stash)
FORWARD_DECLARE(Blob)
FORWARD_DECLARE(CherryPick)
FORWARD_DECLARE(Diff)
FORWARD_DECLARE(Tag)
